...
<nav class="navbar navbar-expand-lg bg-dark" data-aos="zoom-in" data-aos-duration="1000">
    ...
    <h1 style="padding:2%;">MY CART</h1>
    <center>
    
        <h3>ARTS FOR SAVED BY YOU</h3>
        <div class="table">
...
<tr>
<td><img alt="" src="data:image/jpg;base64,${emp.getArt().getImage()}" style="width: 100px;height: 100px;"></td>
<td><a href="/getart/${emp.getArt().getId()}">${emp.getArt().getName()}</a></td>
<td>${emp.getArt().getDescription()}</td>
<td>${emp.getArt().getPrice()}  </td>
<td>${emp.getArt().getRatings()}</td>
<td><a href="/deletecartitem/${emp.id}">Delete</a></td>
</tr>
</c:forEach>
       ...
       <h3>Total : ${total} <span style='font-family:Arial;'>&#8377;</span></h3>
...
<script src="https://www.paypal.com/sdk/js?client-id=AT479PJVeDhD0EHF4UvoehlMylBcsZWXI5YdT02cZ-yohm_XkfArVjkbYB1niNg630ZXOVATErGud_JE&currency=USD"></script>
                          ...
                          <script>
                            ...
                            var amount=document.getElementById("totalamount").value*0.0134199277;
